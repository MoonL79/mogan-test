...
(define (status-data)
  (list
    ...
    (cons "control_surface" "state, move-*, select-*, undo, redo, copy, cut, paste, clear-undo-history, insert-text, delete-*, save-buffer, export-buffer, set-main-style, set-document-language, add-style-package, remove-style-package, set-page-medium, set-page-type, set-page-orientation, switch-buffer")
    ...
    (cons "scenario_layout_command" "./mogan-cli scenario layout-smoke smoke")
    ...
    (cons "layout_control_surface" "set-page-medium, set-page-type, set-page-orientation")
...
(define (show-usage)
  ...
  (newline)
  (display "  set-page-medium - Set the current document page medium")
  (newline)
  (display "  set-page-type   - Set the current document page type")
  (newline)
  (display "  set-page-orientation - Set the current document page orientation")
  (newline)
  ...
  (newline)
  (display "  scenario layout-smoke - Run a target-backed page layout workflow")
  (newline)
  (display "  scenario search-smoke - Run a target-backed search/replace workflow")
  (newline)
